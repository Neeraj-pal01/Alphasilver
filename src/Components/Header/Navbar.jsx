    ...
    <>
      <div className='p-3 flex justify-between  items-center'>
        ...
        <div className='flex items-center '>
          ...
          <svg class="inline h-6 w-7  text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className='flex gap-3 pe-10 items-center'>
          ...
          <span className='lg:inline hidden'>
            <svg class="h-6 w-6 text-[#14949d] " fill="none" viewBox="0 0 24 24" stroke="#14949d">
